...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    public void alternateIterator(LinkedPositionalList<E> L, Iterator<Position<E>> it1, Iterator<Position<E>> it2){
        int middle = L.size()/2;
        int counter = 0;
        while(it1.hasNext() && counter < middle){
            it1.next();
            counter++;
        }
        while(it1.hasNext()) {
            addAfter(it2.next(), remove(it1.next()));
        }
    }
    ...
    public static void main(String[] args) {
        ...
        print(lpl);
        //lpl.swap(p2, p4);
        Iterator<Position<Integer>> it1 = lpl.positions().iterator();
        Iterator<Position<Integer>> it2 = lpl.positions().iterator();
        lpl.alternateIterator(lpl, it1, it2);
        print(lpl);
    }
